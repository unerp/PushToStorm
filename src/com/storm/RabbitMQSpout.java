...
public class RabbitMQSpout extends BaseRichSpout {
  ...
  public void open(final Map config,
	  ...
	  tempMap.put("host", "localhost");
	  tempMap.put("prefetchCount", "3");
	  tempMap.put("queueName", "storm.client");
	  tempMap.put("requeueOnFail", "true");
	  
	  
//	  ConsumerConfig consumerConfig = ConsumerConfig.getFromStormConfig(tempMap);
